...
public class FoodViewModel extends AndroidViewModel {
  ...
  private MediatorLiveData<List<FoodDetails>> foodDetailsMediatorLiveData =
  ...
  private void updateFoodMenu() {
    isFoodCallInProgress =
        FoodRepository.getInstance().getFoodMenu(getApplication().getApplicationContext());
  }
