...
public class HomeScreenActivity extends AppCompatActivity
    implements java.util.Observer, PopupMenu.OnMenuItemClickListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    controller =
        AnimationUtils.loadLayoutAnimation(foodList.getContext(), R.anim.layout_slide_from_bottom);
  ...
  private void subscribeToFoodObserver() {
    if (!foodViewModel.getFoodDetailsMutableLiveData().hasObservers()) {
      foodViewModel
          .getFoodDetailsMutableLiveData()
          .observe(HomeScreenActivity.this, foodMenuObserver);
    }
